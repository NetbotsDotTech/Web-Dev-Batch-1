...
export const dummyProducts = [
    { id: 1, title: 'Running Shoes', price: '5000 ', images: [card11, card12, card13, card14], availableSizes: ['5', '6', '7', '8', '9', '10'], color: 'Red', category: 'men' ,rating:4,
    ...
    { id: 2, title: 'Hiking Boots', price: '7500  ', images: [card21, card22, card23, card24], availableSizes: ['7','8', '9', '10', '11'], color: 'Black', category: 'women',rating:3,
      description: "Durable hiking boots with excellent traction and support. Ideal for rugged terrains and long hikes."
     },
    { id: 3, title: 'Casual Sneakers', price: '4000  ', images: [card31,card32,card33,card34], availableSizes: ['6', '7', '8', '9','10'], color: 'Blue', category: 'men',rating:"****",
       description: "Stylish and versatile casual sneakers suitable for everyday wear. Comfortable for walking and relaxing."
     },
    { id: 4, title: 'Basketball Shoes', price: '6000  ', images: [card41, card42,card43,card44], availableSizes: ['7', '8', '9', '10', '11'], color: 'White', category: 'women',rating:5,
    ...
    { id: 5, title: 'Trail Running Shoes', price: '5500  ', images: [card51, card52,card53,card54], availableSizes: ['4','5', '6', '7', '8'], color: 'Green', category: 'men',rating:3,
      description: "Designed for off-road running, these shoes provide stability and cushioning on rugged trails."
     },
    { id: 6, title: 'Formal Loafers', price: '4500  ', images: [card61,card62,card63,card64], availableSizes: ['6','7','8', '9', '10', '11'], color: 'Brown', category: 'women',rating:1,
      description: "Elegant loafers suitable for formal occasions. Made from premium leather for a sophisticated look."
  
     },
    { id: 7, title: 'Flat Sandals', price: '3000  ', images: [card71,card72,card73,card74], availableSizes: ['5','6', '7', '8'], color: 'Tan', category: 'men' ,rating:2,
      description: "Comfortable and stylish flat sandals, perfect for summer outings and beach days."
  
    },
    { id: 8, title: 'High Top Sneakers', price: '6500  ', images: [card81, card82,card83,card84], availableSizes: ['7', '8', '9', '10'], color: 'Black', category: 'men',rating:3,
      description: "Trendy high-top sneakers offering ankle support and a fashionable look for streetwear."
  
     },
    { id: 9, title: 'Ballet Flats', price: '3500  ', images: [card91,card92,card93,card94], availableSizes: ['5', '6', '7'], color: 'Pink', category: 'women',rating:4 ,
      description: "Chic ballet flats that are both comfortable and stylish, perfect for casual outings or office wear."
     },
    { id: 10, title: 'Slip-On Sneakers', price: '4000  ', images: [card101,card102,card103,card104], availableSizes: ['7', '8', '9'], color: 'Gray', category: 'men',rating:5,
       description: "Convenient slip-on sneakers that combine style with ease of wear, great for everyday activities."
     },
    { id: 11, title: 'Outdoor Sandals', price: '3800  ', images: [card111, card112,card113,card114], availableSizes: ['8', '9', '10'], color: 'Beige', category: 'women' ,rating:1,
      description: "Versatile outdoor sandals designed for comfort and breathability during summer adventures."
  
    },
    { id: 12, title: 'Fitness Shoes', price: '5200  ', images: [card121,card122,card123,card124], availableSizes: ['6', '7', '8', '9'], color: 'Black', category: 'women' ,rating:2,
